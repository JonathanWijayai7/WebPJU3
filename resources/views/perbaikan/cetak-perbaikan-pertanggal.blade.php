...
<head>
    ...
    <title>Cetak Perbaikan dan Penggunaan Pertanggal</title>
...
<body>
    <div id="halaman">
        ...
        <table width="470">
            <center>
                <font size="4"><b>Laporan Perbaikan & Pemakaian Material</b></font><br>
        ...
        <table class="static" align="center" rules="all" border="1px" style="width: 95%">
            ...
            @foreach ($cetakPertanggal as $item)
                <tr>
                    ...
                    <td align="center">{{ date('d F Y', strtotime($item->tgl_lpprbk)) }}</td>
