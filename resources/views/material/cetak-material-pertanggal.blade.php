...
<head>
    ...
    <title>CETAK DATA MATERIAL Pertanggal</title>
...
<body>
    <div id="halaman">
        ...
        <table width="470">
            <center>
                <font size="4"><b>Laporan Akhir Stok Material UPT PJU Kota Cirebon</b></font><br>
    ...
    <div class="form-group">
        <table class="static" align="center" rules="all" border="1px" style="width: 95%">
            ...
            @foreach ($cetakPertanggal as $item)
                ...
                <td align="center">Rp {{ $item->hrg_brg }}</td>
                <td align="center">Rp {{ $item->ttl_brg }}</td>
                <td>{{ $item->ket }}</td>
                </tr>
            @endforeach
        </table>
